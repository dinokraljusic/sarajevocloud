...
public abstract class DefaultARSetup extends Setup {
	...
	private boolean addObjCalledOneTieme = false;
	private ActionWaitForAccuracy minAccuracyAction;
	protected Action rotateGLCameraAction;

	public GL1Renderer getMyRenderer(){ return myRenderer; }
...
public void _b_addWorldsToRenderer(GL1Renderer renderer,
	...
	protected void callAddObjectsToWorldIfNotCalledAlready() {
		Log.i(LOG_TAG, "entering callAddObjectsToWorldIfNotCalledAlready");
